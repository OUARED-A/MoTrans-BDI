...
Statement state=null;
    ...
    public  String connect() {
        ...
        try {
            ...
            // extraire les tables 
    public  String gettable(String ED)
    {
    ...
    try{   
            ...
            tabSchema="";
           ResultSet rsa6=state.executeQuery("select * from Table");
           rsa6.next();
           int i=1;
             System.out.println("la requete non executée");
           while(rsa6.next()) {
               
           	tabSchema=tabSchema+rsa6.getString(3);
